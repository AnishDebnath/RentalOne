...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 bg-transparent relative overflow-hidden">
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full bg-primary-light/40 blur-[120px] pointer-events-none -z-10" />
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16 px-6">
          ...
          >
            Questions Rental <span className="bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent font-display">Businesses Ask</span>
          </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-5xl mx-auto">
          {faqs.map((faq) => {
            ...
            return (
              <div
                key={faq.id}
                className={`bg-white border rounded-2xl transition-all duration-300 overflow-hidden self-start group ${
                  isOpen 
              ...
              >
                ...
                >
                  ...
                  <div className={`w-7.5 h-7.5 rounded-full border flex items-center justify-center shrink-0 transition-all duration-300 ${
                    isOpen 
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <div className="px-5 pb-5 pl-[3.25rem] text-slate-500 text-xs sm:text-sm leading-relaxed border-t border-slate-50/50 pt-3">
                        {faq.answer}
                      </div>
                    </motion.div>
                  )}
