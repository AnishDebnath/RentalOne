...
export default function WhoIsItFor() {
  ...
  return (
    <section id="who-is-it-for" className="py-6 bg-transparent relative overflow-hidden select-none">
      <div className="max-w-7xl mx-auto px-6">
        
        {/* Outer Container with Soft Theme Background */}
        <div className="relative bg-gradient-to-br from-primary-light/40 via-sky-50/20 to-primary-light/30 border border-slate-200/50 rounded-[2.5rem] py-8 px-6 md:py-12 md:px-16 overflow-hidden shadow-[0_12px_40px_-12px_rgba(0,0,0,0.03)]">
          {/* Subtle backglow elements */}
          <div className="absolute top-[-20%] right-[-10%] w-[350px] h-[350px] rounded-full bg-primary-light/50 blur-[100px] pointer-events-none" />
          <div className="absolute bottom-[-20%] left-[-10%] w-[350px] h-[350px] rounded-full bg-sky-100/40 blur-[100px] pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
            ...
            <div className="lg:col-span-5 space-y-6 text-left">
              ...
              <h2 className="font-display text-4xl sm:text-5xl font-black tracking-tight text-slate-950 leading-tight">
                The Ultimate <br className="hidden sm:inline" />
                <span className="bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent">Rental Software</span> <br className="hidden sm:inline" />
              ...
              <div>
                <a 
                  href="#final-cta"
                  className="group px-6 py-3 rounded-xl bg-secondary hover:bg-secondary-hover text-white font-bold text-sm transition-all duration-200 shadow-md shadow-secondary/15 inline-flex items-center gap-1.5 hover:scale-[1.02]"
                >
                  Book a Free Demo
                  ...
                  {categories.filter((_, idx) => idx % 2 === 0).map((card) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="bg-white border border-slate-100 p-8 rounded-[24px] shadow-[0_8px_30px_rgba(0,0,0,0.02)] transition-all text-left flex flex-col min-h-[190px]"
                      >
