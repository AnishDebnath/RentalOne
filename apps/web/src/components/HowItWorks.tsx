...
function BrowseMockup() {
  ...
  return (
    <div className="w-full h-52 bg-gradient-to-tr from-slate-50 via-primary-light/20 to-slate-100 rounded-2xl relative overflow-hidden flex flex-col justify-between p-3.5 border border-slate-100 mb-6 select-none">
      ...
      <div className="relative w-full z-10 flex flex-col gap-1.5">
        ...
        <div className="flex gap-1">
          {chips.map((chip, idx) => (
            <div
              key={chip}
              className={`text-[7.5px] font-bold px-2 py-0.5 rounded-full border transition-all ${
                idx === 0 
      ...
      <div className="grid grid-cols-3 gap-2 relative z-10 mb-1 w-full px-0.5">
        ...
        <div className="bg-white rounded-xl p-2.5 shadow-xs flex flex-col justify-between h-24 relative transition-all duration-300">
          ...
          <div className="absolute -inset-0.5 bg-gradient-to-tr from-primary/5 to-secondary/5 rounded-xl blur-xs -z-10" />
...
function CalendarMockup() {
  return (
    <div className="w-full h-52 bg-gradient-to-tr from-slate-50 via-primary-light/20 to-slate-100 rounded-2xl relative overflow-hidden flex flex-col items-center justify-center p-4 border border-slate-100 mb-6">
      ...
      <motion.div 
        className="relative w-full max-w-[220px] h-[150px] flex items-center justify-center"
        animate={{
          y: [-4, 4, -4],
        }}
        transition={{
      ...
      >
        ...
        <div className="absolute w-[140px] h-[125px] bg-white/40 backdrop-blur-xs border border-white/40 rounded-xl p-2 shadow-sm -translate-x-6 -translate-y-4 -rotate-6 opacity-65 z-0 flex flex-col justify-between">
        ...
        {/* Front Calendar Card */}
        <div className="w-[165px] bg-white border border-slate-100 rounded-xl p-3 shadow-md relative z-10 flex flex-col gap-2">
            ...
            {Array.from({ length: 18 }).map((_, i) => {
              ...
              return (
                <div key={i} className="relative flex items-center justify-center w-5 h-4">
                  ...
                  {isSelected && (
                    <motion.div 
                      className={`absolute inset-y-0.5 bg-primary-light/80 ${
                        isStart ? 'left-1/2 w-1/2 rounded-l-md' : isEnd ? 'right-1/2 w-1/2 rounded-r-md' : 'left-0 right-0'
                      }`}
                      initial={{ scaleX: 0 }}
                      animate={{ scaleX: 1 }}
                  ...
                  {/* Day cell / button */}
                  <motion.div
                    className={`w-4.5 h-4.5 rounded-md flex items-center justify-center text-[7.5px] font-extrabold relative z-10 transition-all ${
                      isSelected 
...
function CheckoutMockup() {
  ...
  return (
    <div className="w-full h-52 bg-gradient-to-tr from-slate-50 via-secondary-light/25 to-slate-100 rounded-2xl relative overflow-hidden flex flex-col items-center justify-center p-4 border border-slate-100 mb-6 select-none">
...
function CollectMockup() {
  ...
  return (
    <div className="w-full h-52 bg-gradient-to-tr from-slate-50 via-emerald-50/20 to-slate-100 rounded-2xl relative overflow-hidden flex flex-col items-center justify-center p-4 border border-slate-100 mb-6 select-none">
...
export default function HowItWorks() {
  return (
    <section id="solution" className="py-24 bg-transparent relative overflow-hidden select-none">
      {/* Background soft ambient glowing circles */}
      <div className="absolute top-[10%] left-[5%] w-[450px] h-[450px] rounded-full bg-primary-light/45 blur-[130px] pointer-events-none -z-10" />
      <div className="absolute bottom-[10%] right-[5%] w-[450px] h-[450px] rounded-full bg-primary-light/35 blur-[130px] pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          >
            A Modern Online <span className="bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent">Booking System</span> for Customers
          </motion.h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 items-stretch max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="group bg-white/60 backdrop-blur-md border border-slate-200/50 rounded-[2.2rem] p-6 sm:p-7 flex flex-col justify-between shadow-xs hover:shadow-md transition-all duration-300 min-h-[410px] relative overflow-hidden"
          >
